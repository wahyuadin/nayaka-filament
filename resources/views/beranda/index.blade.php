...
@section('content')
    <div class="section" id="home">
        <div id="carouselExampleFade" class="carousel slide carousel-fade custom-carousel hero-subtitle text-uppercase"
            data-aos="fade-up" data-aos-delay="0" data-bs-ride="carousel">
            <div class="carousel-inner">
                @foreach ($slide as $slideItem)
                    <div class="carousel-item {{ $slideItem->first_slide == 1 ? 'active' : '' }}">
                        <img src="{{ asset('storage/' . $slideItem->image) }}" class="d-block w-100"
                            alt="{{ $slideItem->nama }}" />
                    </div>
                @endforeach
            </div>
            ...
            <section class="py-5">
                <div class="container text-center">
                  ...
                  ">
                    ...
                    <a href="https://new.nayakaerahusada.com/layanan/provider" target="_blank"
                        class="btn btn-primary rounded-border-3 btn-sm mt-5">
            ...
            <div class="row" data-aos="fade-up" data-aos-delay="200">
                <div class="col-md-6 order-1 order-md-2">
                    <div class="img-wrap position-relative">
                        <img class="img-fluid rounded-4" src="assets/tentang_nakaya.png" alt="" data-aos="fade-up"
                            data-aos-delay="300" />
                    </div>
                </div>
                    ...
                    <div class="row justify-content-end">
                        <div class="col-md-11 mb-4 mt-4 mb-md-0">
                            <span class="subtitle text-uppercase mb-3" data-aos="fade-up"
                                data-aos-delay="0">{{ $about_us->label ?? '-' }}</span>
                            ...
                            <div data-aos="fade-up" data-aos-delay="200">
                                ...
                                <button class="btn btn-primary btn-sm rounded-4" data-bs-toggle="modal"
                                    data-bs-target="#aboutusModal{{ $about_us->id ?? '' }}">
                                ...
                                <div class="row justify-content-end">
                                    <div class="col-lg-11">
                                        <div class="row" data-aos="fade-in" data-aos-delay="200">
                                            @isset($why_us->image)
                                                <img src="{{ asset('storage/' . ($why_us->image ?? 'default.png')) }}"
                                                    style="border-radius: 5%" class="img-fluid mb-4" />
                                            @endisset
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-3">
                        <div class="item__wrap p-4 rounded-4 h-100 shadow-xl d-flex flex-column align-items-center">
                            <div class="item__image mb-3 text-center">
                                <img src="{{ asset('storage/' . ($produkItem->image ?? 'default.png')) }}"
                                    width="{{ $produkItem->width_image ?? '' }}"
                                    height="{{ $produkItem->height_image ?? '' }}" alt="{{ $produkItem->title }}"
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#produkModal{{ $produkItem->id }}">
                                    ...
                                    @foreach ($kegiatan as $kegiatanItem)
                                        <div class="col-md-4">
                                            <div class="service-card rounded-4 h-100 shadow-sm bg-white">
                                                <img src="{{ asset('storage/' . $kegiatanItem->image) }}"
                                                    alt="Digital Payments Icon"
                                                    class="card-img-top fade-hover rounded-2" />
                                                <div class="p-4">
                                                    <h3 class="fs-5 mb-3">
                                                    ...
                                                    <a href="{{ route('kegiatan.slug', $kegiatanItem->slug) }}"
                                                        class="special-link d-inline-flex align-items-center text-decoration-none">
                ...
                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <div class="row g-4 justify-content-center">
                        <div class="col-md-6 col-lg-4">
                            <div
                                class="service-card rounded-4 h-100 shadow-sm bg-white d-flex flex-column align-items-center">
                                <div class="ratio ratio-16x9 rounded-2 w-100">
                                    <iframe src="https://www.youtube.com/embed/LMpNtg4_9gU?si=tl-A6j2hMhFgFuEU"
                                ...
                                <div class="p-4 w-100">
                                    ...
                                    <a href="https://www.youtube.com/watch?v=0Pz5QFOrKlk" target="_blank"
                                        class="special-link d-inline-flex align-items-center text-decoration-none">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div
                                class="service-card rounded-4 h-100 shadow-sm bg-white d-flex flex-column align-items-center">
                                <div class="ratio ratio-16x9 rounded-2 w-100">
                                    <iframe src="https://www.youtube.com/embed/LT6UruDgoEY?si=Jn54IxlEMtFA6pQW"
                                        title="Kegiatan Nayaka" allowfullscreen></iframe>
                                </div>
                                <div class="p-4 w-100">
                                    <h3 class="fs-5 mb-3">
                                    ...
                                    <a href="https://www.youtube.com/watch?v=4Q1F1kK5QvI" target="_blank"
                                        class="special-link d-inline-flex align-items-center text-decoration-none">
                                        <i class="bi bi-arrow-right-short me-1"></i>Lihat di
                                        YouTube
                                    </a>
                            ...
                            <div
                                ...
                                <div class="ratio ratio-16x9 rounded-2 w-100">
                                    <iframe width="560" height="315"
                                        src="https://www.youtube.com/embed/q_fuJkUG4I4?si=5oZXYWmzVsOgk4Qx"
                                ...
                                <div class="p-4 w-100">
                                    ...
                                    <a href="https://www.youtube.com/embed/q_fuJkUG4I4" target="_blank"
                                        class="special-link d-inline-flex align-items-center text-decoration-none">
                                        <i class="bi bi-arrow-right-short me-1"></i>Lihat di
                                        YouTube
                                    </a>
                            ...
                            <div class="testimonial-author d-flex gap-3 align-items-center">
                                <div class="author-img">
                                    <img class="rounded-circle img-fluid"
                                        src="{{ asset('/storage/' . $testimoniItem->image) }}"
                                        alt="{{ $testimoniItem->nama }}" />
                                </div>
                                <div class="lh-base">
