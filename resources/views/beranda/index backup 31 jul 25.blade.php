                ...
                <div class="logo-marquee-horizontal">
                    <div class="logo-track-horizontal">
                        ...
                        <div class="logo-group-horizontal">
                            ...
                            <img src="{{ asset('storage/' . $pk->image) }}" alt="{{ $pk->image }}" style="width: {{ $pk->width ?? '' }}; height: {{ $pk->height ?? '' }}" />
                            @endforeach
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="service-card rounded-4 h-100 shadow-sm bg-white d-flex flex-column align-items-center">
                            ...
                            <div class="p-4 w-100">
                                ...
                                <p>
                                    {{ Str::limit($videoItem->description, 120) }}
                                </p>
            ...
            {{-- <div class="col-md-6">
                <div class="d-flex gap-5 flex-column">
                    <div class="d-flex align-items-start gap-3" data-aos="fade-up" data-aos-delay="0">
                        ...
                        <span>
                            <span class="d-block">TELEPON SEKARANG</span><strong>021-5260518</strong></span>
                    </div>
                    <div class="d-flex align-items-start gap-3" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <span>
                            <span class="d-block">EMAIL KAMI KAPAN SAJA</span><strong>pusat@nayakaerahusada.com </strong></span>
                    </div>
                    ...
                    <form id="contactForm">
                        <div class="row gap-3 mb-3">
                            <div class="col-md-12">
                                ...
                                <input class="form-control" id="name" type="text" name="name" required placeholder="Masukkan Nama Lengkap" />
                            </div>
                            <div class="col-md-12">
                                <label class="mb-2" for="email">Alamat Email</label>
                                <input class="form-control" id="email" type="email" name="email" required placeholder="Masukkan Alamat Email" />
                            </div>
                        </div>
                        <div class="row gap-3 mb-3">
                            <div class="col-md-12">
                                <label class="mb-2" for="subject">Subjek</label>
                                <input class="form-control" id="subject" type="text" name="subject" placeholder="Masukkan Subjek" />
                            </div>
                        </div>
