                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                            <div class="card h-100 shadow-sm border-0 rounded-4 p-4 text-center">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title fw-bold mb-2">{{ $kapu->title }}</h5>
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                            <div class="card h-100 shadow-sm border-0 rounded-4 p-4 text-center">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        <a href="mailto:{{ $kapu->email }}"
                                            class="text-decoration-none text-dark">{{ $kapu->email }}</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        @foreach ($kapu->telp as $telpItem)
                                            <a href="tel:{{ $telpItem['nomor'] }}"
                                                class="text-decoration-none text-dark d-block">{{ $telpItem['nomor'] }}</a>
                                        @endforeach
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="row mb-5" data-aos="fade-up" data-aos-delay="600">
                        <div class="col-12">
                            ...
                            <div class="map-container rounded-4 shadow-sm overflow-hidden">
                                <iframe src="{{ $kapu->google_maps }}" width="100%" height="450" style="border:0;"
