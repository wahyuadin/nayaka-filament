             ...
             <div class="offcanvas-header">
                 <div class="offcanvas-header-logo">
                     <a class="logo-link" id="fbs__net-navbarsLabel" href="index.html">
                         <img class="logo dark img-fluid" src="{{ asset('assets/icon.png') }}" width="150"
                             alt="FreeBootstrap.net image placeholder" />

                         <img class="logo light img-fluid" src="{{ asset('assets/icon.png') }}"
                 ...
                 <ul class="navbar-nav nav me-auto ps-lg-5 mb-2 mb-lg-0">
                     ...
                     <li class="nav-item dropdown">
                         <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"
                             aria-expanded="false"><b>Tentang</b> <i class="bi bi-chevron-down"></i></a>

                         <ul class="dropdown-menu">
                             <li>
                                 <a class="nav-link scroll-link dropdown-item" href="{{ url('/#about') }}">Tentang
                                     Kami</a>
                             </li>
                             <li>
                                 <a class="nav-link scroll-link dropdown-item"
                                     href="{{ route('management.index') }}">Tim Management</a>
                             </li>
                         </ul>
                     </li>
                     <li class="nav-item">
                     ...
                     <li class="nav-item dropdown">
                         <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"
                             aria-expanded="false"><b>Layanan</b> <i class="bi bi-chevron-down"></i></a>

                         <ul class="dropdown-menu">
                             <li>
                                 <a class="nav-link scroll-link dropdown-item"
                                     href="{{ route('layanan.klinik') }}">Klinik</a>
                             </li>
                             <li>
                                 <a class="nav-link scroll-link dropdown-item"
                                     href="{{ route('layanan.provider') }}">Provider</a>
                             </li>
                             <li>
                                 <a class="nav-link scroll-link dropdown-item"
                                     href="{{ route('layanan.inhouse') }}">Kerjasama Perusahaan</a>
                             </li>
                             <li>
                                 <a class="nav-link scroll-link dropdown-item"
                                     href="{{ route('layanan.download') }}">Download Formulir</a>
                             </li>
                             <li>
                     ...
                     <li class="nav-item">
                         <a class="nav-link scroll-link" href="{{ route('kontak.index') }}"><b>Kontak</b></a>
                     </li>
                 </ul>
                 <div class="offcanvas-body align-items-lg-center">
                     ...
                     <div class="mt-auto pt-3 pt-lg-0 d-lg-flex align-items-lg-center">
                         ...
                         <div class="d-grid d-lg-block">
                             <a target="_blank" href="{{ url('panel') }}"
                                 class="btn btn-warning d-inline-flex align-items-center justify-content-center fw-bold px-2 py-1"
                                 style="
                                            font-size: 0.8rem;
