          ...
          <div class="offcanvas offcanvas-start w-75" id="fbs__net-navbars" tabindex="-1" aria-labelledby="fbs__net-navbarsLabel">
              ...
              <div class="offcanvas-body align-items-lg-center">
                  <ul class="navbar-nav nav me-auto ps-lg-5 mb-2 mb-lg-0">
                      <li class="nav-item">
                          <a class="nav-link scroll-link {{ Request::is('/') ? 'active' : '' }}" aria-current="page" href="{{ url('/#home') }}"><b>Home</b></a>
                      </li>
                  ...
                  <div class="offcanvas-body align-items-lg-center">
                      ...
                      <div class="mt-auto pt-3 pt-lg-0 d-lg-flex align-items-lg-center">
                          <ul class="navbar-nav nav mb-3 mb-lg-0">
                              <li class="nav-item dropdown">
                                  <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" data-bs-toggle="dropdown" aria-expanded="false" id="current-lang">
                                      <img id="lang-flag" src="https://i.pinimg.com/736x/91/3d/f8/913df8098c7237aae279c4628302f49c.jpg" alt="Indonesia Flag" width="24" height="16" class="me-2" />
                                      <b id="lang-label">ID</b> <i class="bi bi-chevron-down ms-1"></i>
                                  </a>
