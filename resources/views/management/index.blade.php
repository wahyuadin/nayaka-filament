...
<head>
    ...
    <title>Nayaka Era Husada - Tim Management</title>
    <meta name="description" content="Kenali tim manajemen PT Nayaka Era Husada yang berpengalaman dan berdedikasi dalam menyediakan layanan kesehatan terpercaya." />
    <meta name="keywords" content="Nayaka Era Husada, tim manajemen, pimpinan, direksi, profil tim, kesehatan" />
    <meta name="author" content="PT Nayaka Era Husada" />
    <link rel="canonical" href="https://www.nayakaerahusada.com/management.html" />

    <meta property="og:title" content="Nayaka Era Husada - Tim Management" />
    <meta property="og:description" content="Kenali tim manajemen PT Nayaka Era Husada yang berpengalaman dan berdedikasi dalam menyediakan layanan kesehatan terpercaya." />
    <meta property="og:image" content="https://new.nayakaerahusada.com/assets/images/logo_nayaka2.png" />
    <meta property="og:url" content="https://www.nayakaerahusada.com/management.html" />
    <meta property="og:type" content="website" />

    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Nayaka Era Husada - Tim Management" />
    <meta name="twitter:description" content="Kenali tim manajemen PT Nayaka Era Husada yang berpengalaman dan berdedikasi dalam menyediakan layanan kesehatan terpercaya." />
    ...
    <div class="site-wrap">
        <header class="fbs__net-navbar navbar navbar-expand-lg dark" aria-label="freebootstrap.net navbar">
            <div class="container d-flex align-items-center justify-content-between">
                <a class="navbar-brand w-auto" href="{{ url('/') }}">
                    <img class="logo dark img-fluid" src="assets/icon.png" alt="Logo Nayaka Era Husada" width="160" />

                    <img class="logo light img-fluid" src="assets/icon.png" alt="Logo Nayaka Era Husada" />
                </a>
                <div class="offcanvas offcanvas-start w-75" id="fbs__net-navbars" tabindex="-1" aria-labelledby="fbs__net-navbarsLabel">
                    <div class="offcanvas-header">
                        <div class="offcanvas-header-logo">
                            <a class="logo-link" id="fbs__net-navbarsLabel" href="{{ url('/') }}">
                                <img class="logo dark img-fluid" src="assets/icon.png" width="150" alt="Logo Nayaka Era Husada" />

                                <img class="logo light img-fluid" src="assets/icon.png" alt="Logo Nayaka Era Husada" /></a>
                        </div>
                    ...
                    <div class="offcanvas-body align-items-lg-center">
                        <ul class="navbar-nav nav me-auto ps-lg-5 mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link scroll-link" aria-current="page" href="{{ url('/') }}#home"><b>Home</b></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link scroll-link" href="{{ url('/') }}#about"><b>Tentang</b></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link scroll-link" href="{{ url('/') }}#pricing"><b>Produk</b></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link scroll-link" href="{{ url('/') }}#services"><b>Kegiatan</b></a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false"><b>Layanan Nayaka</b> <i class="bi bi-chevron-down"></i></a>

                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="nav-link scroll-link dropdown-item" href="https://nayakaerahusada.com/layanan/klinik">Klinik Nayaka</a>
                                    </li>
                                    <li>
                                        <a class="nav-link scroll-link dropdown-item" href="https://nayakaerahusada.com/layanan/provider">Provider Nayaka</a>
                                    </li>
                                    <li>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link scroll-link active" href="#" data-bs-toggle="dropdown" aria-expanded="false"><b>Tentang Nayaka</b> <i class="bi bi-chevron-down"></i></a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link scroll-link" href="https://new.nayakaerahusada.com/kontak"><b>Kontak Nayaka</b></a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <main>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 text-center">
                            <img src="assets/management/konten_header.JPG" alt="Struktur Manajemen dan Kepemimpinan" class="img-fluid rounded-4 shadow-lg" style="
                    max-width: 500px;
                  ...
                  " onmouseover="this.style.transform='scale(1.03)'; this.style.boxShadow='0 12px 24px rgba(0,0,0,0.3)';" onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 8px 16px rgba(0,0,0,0.2)';" />
                        ...
                        <div class="col-lg-6 mt-4 mt-lg-0">
                            <h3>Struktur Manajemen & Kepemimpinan</h3>
                            <p class="lead">
                                Dewan Komisaris, Direktur Utama, Direktur, Senior Manager
                                Operasi & Hub.PPK, Senior Manager Pelayanan, Senior Manager
                                Keuangan, Senior Manager Umum dan SDM. Mereka semua merupakan
                                orang-orang terampil yang berintegritas, pekerja keras dan
                                hasil berkualitas, menjaga kesinambungan untuk melangkah
                            ...
                            <div class="card shadow-sm border-0 rounded-4 h-100 overflow-hidden transition">
                                <div class="card-body pb-0">
                                    <h6 class="card-title fw-semibold">
                                        Senior Manager Operasi &amp; Hub. PKK
                                    </h6>
                                </div>
            ...
            <div class="shortcut">
                ...
                <a href="{{ url('/') }}#faqu" class="link-shortcut faq">
            ...
            <div class="container">
                <div class="row justify-content-between mb-5 g-xl-5">
                    <div class="col-md-4 mb-5 mb-lg-0">
                        <div class="">
                            <img class="" src="assets/footer_putih.png" width="230" alt="Logo Nayaka Era Husada Footer" />
                        </div>
                        ...
                        <div class="row g-2">
                            <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li>
                                        <a href="https://new.nayakaerahusada.com/kontak">F.A.Q</a>
                                    </li>
                                    <li>
                                        <a href="https://new.nayakaerahusada.com/kontak">Kontak Kami</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md-5 col-lg-4 mb-4 mb-lg-0">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="https://nayakaerahusada.com/layanan/inhouse">Download Formulir</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md-7 col-lg-4 mb-4 mb-lg-0 quick-contact">
                                ...
                                <a class="d-flex mb-3" href="mailto:pusat@nayakaerahusada.com"><i class="bi bi-envelope-fill me-3" style="color: white"></i><span>pusat@nayakaerahusada.com</span></a><a class="d-flex mb-3" href="tel://+62215260518"><i class="bi bi-telephone-fill me-3" style="color: white"></i><span>+62 215-260-518</span></a>
                                <p class="d-flex mb-3">
                ...
                <div class="row align-items-center credits pt-3" style="color: white">
                    <div class="row align-items-center credits pt-3" style="color: white">
                        ...
                        <div class="col-12 col-xl-4 text-center text-xl-end">
                            <img src="https://new.nayakaerahusada.com/assets/images/ukas.png" alt="UKAS" class="img-fluid" style="max-height: 100px; filter: brightness(0) invert(1)" />
                        </div>
                    </div>
                </div>
            </div>
